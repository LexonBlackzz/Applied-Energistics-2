...
public class RenderBlockOutlineHook {
    ...
    record PartPlacementPreviewRenderer(PartPlacement.Placement placement,
        ...
        public boolean render(BlockOutlineRenderState blockOutlineRenderState,
            ...
            renderPart(poseStack, submitNodeCollector, cameraRelativePos, part, placement.side(), PREVIEW_LINE_WIDTH, false,
                    true, true);
            renderPart(poseStack, submitNodeCollector, cameraRelativePos, part, placement.side(), PREVIEW_LINE_WIDTH, false,
                    true, false);
            return false;
    ...
    record FacadePlacementPreviewRenderer(Direction side, IFacadePart facade,
        ...
        public boolean render(BlockOutlineRenderState blockOutlineRenderState,
            ...
            showFacadePlacementPreview(poseStack, cameraRelativePos, submitNodeCollector, true);
            showFacadePlacementPreview(poseStack, cameraRelativePos, submitNodeCollector, false);
            return false;
        }
        ...
        private void showFacadePlacementPreview(PoseStack poseStack,
            ...
            if (renderAnchor) {
                ...
                renderPart(poseStack, submitNodeCollector, cameraRelativePos, cableAnchor, side, PREVIEW_LINE_WIDTH, false, true,
                        insideBlock);
            }

            renderFacade(poseStack, submitNodeCollector, cameraRelativePos, facade, side, PREVIEW_LINE_WIDTH, false, true,
                    insideBlock);
        }
    }
    ...
    record FacadeOutlineRenderer(IFacadePart facade, Direction side,
        ...
        @Override
        public boolean render(BlockOutlineRenderState blockOutlineRenderState,
                SubmitNodeCollector submitNodeCollector, PoseStack poseStack,
                LevelRenderState levelRenderState) {
            renderFacade(poseStack, submitNodeCollector, cameraRelativePos, facade, side, lineWidth, highContrast, false,
                    false);
    ...
    record PartOutlineRenderer(IPart part, Direction side,
        ...
        public boolean render(BlockOutlineRenderState blockOutlineRenderState,
                SubmitNodeCollector submitNodeCollector, PoseStack poseStack,
                LevelRenderState levelRenderState) {
            renderPart(poseStack, submitNodeCollector, cameraRelativePos, part, side, lineWidth, highContrast, false, false);
            return true;
        }
    }
    ...
    private static void renderPart(PoseStack poseStack,
        ...
        renderBoxes(poseStack, submitNodeCollector, cameraRelativePos, boxes, lineWidth, highContrast, preview, insideBlock);
    }
    ...
    private static void renderBoxes(PoseStack poseStack,
        ...
        if (preview) {
            ...
            renderBoxes(poseStack, submitNodeCollector, cameraRelativePos, boxes, renderType, color, lineWidth);
        } else {
            if (highContrast) {
                renderBoxes(poseStack, submitNodeCollector, cameraRelativePos, boxes, RenderTypes.secondaryBlockOutline(),
            ...
            renderBoxes(poseStack, submitNodeCollector, cameraRelativePos, boxes, RenderTypes.lines(), color, lineWidth);
        }
    }
